...
import { ArrowRight, ArrowsClockwise, CheckCircle, Clock, Network, WarningCircle, WifiHigh } from '@phosphor-icons/react';
          ...
          <div className="flex flex-col justify-between gap-4">
            <div className="space-y-3">
              <div className="rounded-lg border border-slate-200 px-3 py-2 ">
                ...
                <p className="mt-1 text-sm font-medium text-slate-900 ">Add tank dimensions to calibrate readings.</p>
              </div>
              <div className="rounded-lg border border-slate-200 px-3 py-2 ">
      ...
      <div className="grid gap-4 p-4 md:grid-cols-[0.9fr_1.1fr]">
        ...
        {claimCode && step === 'waiting' && (
          <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 ">
            <p className="text-xs font-medium uppercase tracking-wide text-slate-500 ">Pairing code</p>
 ...
 Waiting for connection. Expires in {secondsLeft}s.
        ...
        {step === 'idle' && (
          <div className="rounded-lg border border-dashed border-slate-300 bg-slate-50 px-4 py-5 text-center ">
            ...
            <p className="text-sm text-slate-500 ">Codes expire quickly to keep account linking controlled.</p>
          </div>
        )}
