...
import { CaretDown, CaretUp, Cylinder, FloppyDisk, Gauge, Ruler, Stack, WarningCircle } from '@phosphor-icons/react';
...
export function TankSetupWizard({
      ...
      <div className="border-b border-slate-100 px-4 py-3 ">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold tracking-tight text-slate-950 ">Tank calibration</h2>
 ...
 Advanced: sensor calibration
                {showAdvanced ? <CaretUp className="h-3 w-3" /> : <CaretDown className="h-3 w-3" />}
              </button>
              {showAdvanced && (
          ...
          <div className="space-y-3">
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-4 ">
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-xs font-medium uppercase tracking-wide text-slate-500 ">Total capacity</p>
                  <p className="mt-1 text-2xl font-semibold tracking-tight text-slate-950 ">{totalCapacityL.toFixed(0)}L</p>
                </div>
            ...
            <div className="flex gap-3">
              <Button variant="secondary" className="w-full" onClick={() => setStep('dimensions')}>
 Back
              </Button>
