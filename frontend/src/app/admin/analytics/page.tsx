          ...
          <Card className="border-slate-200 shadow-sm">
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between rounded-lg bg-sky-50 px-4 py-3">
                <div>
                  ...
                  <p className="text-xs text-sky-700">
                    Today&apos;s average across registered tanks
                  </p>
                </div>
              ...
              <div className="mt-3 grid grid-cols-7 items-end gap-1.5">
                {[35, 52, 48, 66, 58, 78, Math.min(100, Math.max(16, measurementDensity * 8))].map(
                  (height, index) => (
                    <div
                      key={`${height}-${index}`}
                      className="flex h-24 items-end rounded-md bg-slate-100 p-1"
                    >
                      <div
          ...
          <CardContent className="grid gap-3 p-4 md:grid-cols-3">
            <div className="rounded-lg border border-slate-200 px-3 py-2">
              ...
              <p className="mt-1 text-sm font-semibold text-slate-950">
                {measurementsToday} readings today
              </p>
            </div>
            <div className="rounded-lg border border-slate-200 px-3 py-2">
