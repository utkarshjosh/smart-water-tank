...
import { Buildings, Copy, Cpu, Drop, MagnifyingGlass, Plus, Radio, WarningCircle } from '@phosphor-icons/react';
...
export default function DevicesPage() {
    ...
    <AppShell variant="admin">
      <div className="space-y-5">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <h1 className="text-2xl font-semibold tracking-tight text-slate-950 ">Device inventory</h1>
 ...
 Create device
        ...
        <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
          {[
            ...
            { label: 'Offline', value: offlineDevices, detail: 'Need attention', icon: WarningCircle },
            { label: 'Tenants', value: assignedTenants, detail: 'With assigned hardware', icon: Buildings },
            { label: 'Stored volume', value: `${totalVolume.toFixed(0)}L`, detail: 'Latest readings', icon: Drop },
          ].map((metric) => {
 ...
 device.status === 'online' ? 'bg-emerald-500' : 'bg-rose-500'
                    ...
                    <div className="min-w-0">
                      <div className="truncate text-sm font-medium text-slate-700 ">{device.tenant_name}</div>
