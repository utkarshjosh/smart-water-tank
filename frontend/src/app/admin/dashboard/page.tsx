...
import { Gauge, HardDrives, Pulse, Users, Warning, WarningCircle, WifiHigh, WifiSlash } from '@phosphor-icons/react';
            ...
            <CardContent className="space-y-5 p-4">
              <div>
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-slate-950 ">{onlineDevices}/{totalDevices}</span>
                </div>
