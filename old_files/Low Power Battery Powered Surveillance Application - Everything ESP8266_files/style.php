...
body {
    /* RICK font-family: 'Source Sans Pro','Arial','Helvetica',sans-serif; */
    margin: 0;
    color: #8d9aa5;
...
}.postbody .content {font-size:14px !important;overflow: hidden;}.description, .subforums, .forum-time, .forum-mods {font-size: 15px;}